...
export default function Footer() {
  return (
    <footer id="footer" className="border-t border-[#e7eaf3] bg-[#f5f7fb] py-10">
      <div className="mx-auto flex max-w-6xl flex-col gap-4 px-5 sm:flex-row sm:items-center sm:justify-between sm:px-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-[#3d4a68]">Journey architects for people who love great stays.</p>
          </div>
        </div>
        <div className="flex flex-wrap gap-3 text-sm text-[#3d4a68]">
          ...
          <span className="rounded-full bg-white px-4 py-2">+34 000 000 000</span>
        </div>
      </div>
    </footer>
  );
